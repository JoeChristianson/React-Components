import { faFacebook, faTwitter, faInstagram, faLinkedin, faYoutube, faPinterest, faSnapchat, faTiktok, faReddit, faTumblr, faFlickr, faTwitch, faVimeo, faWhatsapp, faTelegram, faDiscord } from '@fortawesome/free-brands-svg-icons';
import { faPaperPlane } from '@fortawesome/free-solid-svg-icons';
var socialMediaIcons = new Map();
...
var getSocialIcon = function (platform) {
    var icon = socialMediaIcons.get(platform);
    return icon;
};
